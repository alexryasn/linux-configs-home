#!/bin/sh
i3-msg --no-startup-id exec 'xbacklight = 50'
...
i3-msg --no-startup-id exec 'nitrogen --restore'
...
i3-msg exec skype
#i3-msg exec pidgin
i3-msg exec --no-startup-id 'yandex-disk start'
i3-msg exec --no-startup-id 'dropbox start'
i3-msg exec --no-startup-id xxkb